...
from lib.utils import (
    ...
    seed_everything,
    set_cpu_num,
    CustomJSONEncoder, load_pickle, get_adjacency_matrix, scaled_Laplacian
)

from lib.metrics import RMSE_MAE_MAPE
from lib.data_prepare import get_dataloaders_from_index_data
from model.DMGFCRN import DMGFCRN
...
if __name__ == "__main__":
    ...
    model = DMGFCRN(G, **cfg["model_args"])
